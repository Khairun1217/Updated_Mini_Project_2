...
private String password;
	...
	public void initalize() throws IOException {
		...
		String reportName = System.getProperty("user.dir") + "/Reports/ExtentReporter_" + timestamp + ".html";
    ...
    @Test(priority = 1,dataProvider = "getTestData",dataProviderClass = GetTestData.class)
    ...
    @Test(priority = 2,dataProvider = "getTestData",dataProviderClass = GetTestData.class)
